...
def create_app(test_config=None):
    ...
    def index_get():
        ...
        return render_template('home/home.html',enc_token_text=enc_token_text,dec_token_text=dec_token_text)
    ...
    @app.route('/analyze/<int:dec_idx>', methods=('GET', 'POST'))
    def analyze(dec_idx):
        ...
        return render_template('analyze_token/analyze.html',sel_token=decoder_text[dec_idx],pred_info=pred_info,enc_info=encoder_att_info,dec_info=decoder_att_info,ig_info=ig_info)
